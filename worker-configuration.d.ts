/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 7923929f01cddd4262cee96763d624db)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 
interface __BaseEnv_CloudflareBindings {
	COUNTER: DurableObjectNamespace<import("./src/index").CounterDurableObject>;
	MATCHER: DurableObjectNamespace<import("./src/index").MatcherDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CounterDurableObject" | "MatcherDurableObject";
	}
